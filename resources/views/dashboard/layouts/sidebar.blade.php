    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item has-sub {{ Request::is('dashboard/pengajuan/*') ? 'active' : '' }}">
                    <a href="#" class="sidebar-link">
                        <i class="bi bi-person"></i>
                        <span>Pengajuan</span>
                    </a>
                    <ul class="submenu {{ Request::is('dashboard/pengajuan/create_pelayanan*') ? 'active' : '' }}">
                        <li class="submenu-item {{ Request::is('/dashboard/pengajuan/create_pelayanan*') ? 'active' : '' }}">
                            <a href="/dashboard/pengajuan/create">SKTP</a>
                        </li>
                        <li class="submenu-item {{ Request::is('dashboard/user/account/setting*') ? 'active' : '' }}">
                            <a href="/dashboard/complaints">SKCK</a>
                        </li>
                        <li class="submenu-item {{ Request::is('dashboard/user/account/password*') ? 'active' : '' }}">
                            <a href="/dashboard/complaints">SPENU</a>
                        </li>
                        <li class="submenu-item {{ Request::is('dashboard/user/account/password*') ? 'active' : '' }}">
                            <a href="/dashboard/complaints">SKD</a>
                        </li>
                        <li class="submenu-item {{ Request::is('dashboard/user/account/password*') ? 'active' : '' }}">
                            <a href="/dashboard/complaints">SK USAHA</a>
                        </li>
                        <li class="submenu-item {{ Request::is('dashboard/user/account/password*') ? 'active' : '' }}">
                            <a href="/dashboard/complaints">SKTM</a>
                        </li>
                        <li class="submenu-item {{ Request::is('dashboard/user/account/password*') ? 'active' : '' }}">
                            <a href="/dashboard/complaints">SIK</a>
                        </li>
                        <li class="submenu-item {{ Request::is('dashboard/user/account/password*') ? 'active' : '' }}">
                            <a href="/dashboard/complaints">SPRU</a>
                        </li>
                        <li class="submenu-item {{ Request::is('dashboard/user/account/password*') ? 'active' : '' }}">
                            <a href="/dashboard/complaints">SAW</a>
                        </li>
                        <li class="submenu-item {{ Request::is('dashboard/user/account/password*') ? 'active' : '' }}">
                            <a href="/dashboard/complaints">SKAWIN</a>
                        </li>
                    </ul>
                    @can('student')
                ...
                <li class="sidebar-item has-sub {{ (Request::is('dashboard/users*') or Request::is('dashboard/user/register')) ? 'active' : '' }}">
                    <a href="#" class="sidebar-link">
