        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton" style="min-width: 11rem">
                    ...
                    <li>
                        <a class="dropdown-item @if (Request::is('dashboard/user/account/profile*')) active @endif" href="/dashboard/user/account/profile"><i class="icon-mid bi bi-person me-2"></i> Profil
                            Saya</a>
                    </li>
                    <li>
                        <a class="dropdown-item @if (Request::is('dashboard/user/account/setting*')) active @endif" href="/dashboard/user/account/setting"><i class="icon-mid bi bi-gear me-2"></i>
                            Pengaturan Akun</a>
                    </li>
                    <li>
                        <a class="dropdown-item @if (Request::is('dashboard/user/account/password*')) active @endif" href="/dashboard/user/account/password"><i class="icon-mid bi bi-key me-2"></i>
                            Password</a>
                    </li>
                    <li>
