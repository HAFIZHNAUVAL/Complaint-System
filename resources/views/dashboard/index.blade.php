                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <a data-bs-toggle="tooltip" data-bs-original-title="Rincian dari keluhan milik {{ $complaint->student->user->name }}." href="/dashboard/responses/create/{{ $complaint->slug }}" class="btn btn-info px-2 pt-2">
                                                        <span class="fa-fw fa-lg select-all fas"></span>
                                                    </a>
                                                    @elseif($complaint->status < 2) <a data-bs-toggle="tooltip" data-bs-original-title="Menanggapi keluhan milik {{ $complaint->student->user->name }}." href="/dashboard/responses/create/{{ $complaint->slug }}" class="btn btn-warning px-2 pt-2">
                                                        <span class="fa-fw fa-lg select-all fas"></span>
                                                        </a>
                                                        @endif
                                                </div>
                        ...
                        <a href="/dashboard/responses/create/{{ $complaint->slug }}">
                            <div class="recent-message d-flex px-4 py-3">
                                <div class="avatar avatar-lg">
                                    ...
                                    <img src="{{ asset('storage/' . $complaint->student->user->image) }}" alt="User avatar" />
                                    @else
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-0 px-4 mt-3 mb-4 pb-2">
                            <div class="col-md-2 d-flex align-items-start">
                                ...
                                <img width="200" src="{{ asset('storage/' . $response->officer->user->image) }}" alt="User avatar" class="img-fluid rounded-circle mx-auto">
                                @else
                                @if ($response->officer->user->gender == 'L')
                                <img width="200" src="{{ asset('assets/static/images/faces/2.jpg') }}" alt="User avatar" class="img-fluid rounded-circle mx-auto">
                                @else
                                <img width="200" src="{{ asset('assets/static/images/faces/5.jpg') }}" alt="User avatar" class="img-fluid rounded-circle mx-auto">
                                @endif
                                @endif
                            </div>
                            <div class="col-md-10">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    @elseif($complaint->status < 2) <div class="me-2">
                                                        <a data-bs-toggle="tooltip" data-bs-original-title="Menanggapi keluhan milik {{ $complaint->student->user->name }}." href="/dashboard/responses/create/{{ $complaint->slug }}" class="btn btn-warning px-2 pt-2">
                                                            <span class="fa-fw fa-lg select-all fas"></span>
                                                        </a>
                                                </div>
                                                @endif
        ...
        <div class="col-12" id="recent-responses">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="text-subtitle text-muted" href="/dashboard/complaints/{{ $response->complaint->slug }}">
                        <div class="row g-0 px-4 mt-3 mb-4 pb-2">
                            <div class="col-md-2 d-flex align-items-start">
                                @if ($response->officer->user->image)
                                <img width="200" src="{{ asset('storage/' . $response->officer->user->image) }}" alt="User avatar" class="img-fluid rounded-circle mx-auto">
